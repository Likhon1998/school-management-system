<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">✏️ Edit Student</h2>
                ...
                <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="student_name" value="{{ old('student_name', $student->student_name) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="government_id" value="{{ old('government_id', $student->government_id) }}" 
                        ...
                        <div>
                            ...
                            <select name="section_id" class="w-full border-gray-300 rounded-lg shadow-sm text-sm" required>
                                ...
                                @foreach($sections as $section)
                                    <option value="{{ old('section_id', $student->section_id) }}" {{ $student->section_id == $section->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" name="roll_number" value="{{ old('roll_number', $student->roll_number) }}" 
                                   class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-indigo-200 text-sm">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" class="w-full border-gray-300 rounded-lg shadow-sm text-sm" rows="2">{{ old('address', $student->address) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            @if($student->photo)
                                <img src="{{ asset('storage/profiles/'.$student->photo) }}" class="w-20 h-20 mt-2 rounded-full border" alt="Current Photo">
                            @endif
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="medical_info" class="w-full border-gray-300 rounded-lg shadow-sm text-sm" rows="2">{{ old('medical_info', $student->medical_info) }}</textarea>
                        </div>
