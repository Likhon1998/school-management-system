<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-800">✏️ Edit Section</h2>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 text-center bg-green-100">
                    <h3 class="text-lg font-semibold text-green-800">Edit Section</h3>
                </div>
                ...
                <div class="px-6 py-6 space-y-4">
                    <form action="{{ route('sections.update', $section->id) }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="capacity" value="{{ old('capacity', $section->capacity) }}" 
                                   class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-1 focus:ring-green-400 focus:outline-none">
                        ...
                        <div>
                            ...
                            <input type="text" name="room_number" value="{{ old('room_number', $section->room_number) }}" 
                                   class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-1 focus:ring-green-400 focus:outline-none">
