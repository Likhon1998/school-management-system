                ...
                <form action="{{ route('fee_structures.update', $feeStructure->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="class_id" class="w-full border-gray-300 rounded text-sm focus:ring-2 focus:ring-green-300 focus:outline-none">
                        ...
                        <div>
                            ...
                            <select name="academic_year_id" class="w-full border-gray-300 rounded text-sm focus:ring-2 focus:ring-green-300 focus:outline-none">
                        ...
                        <div>
                            ...
                            <select name="fee_type" class="w-full border-gray-300 rounded text-sm focus:ring-2 focus:ring-green-300 focus:outline-none">
                        ...
                        <div>
                            ...
                            <select name="month" class="w-full border-gray-300 rounded text-sm focus:ring-2 focus:ring-green-300 focus:outline-none">
                                <option value="">Select Month (if applicable)</option>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="exam_name" value="{{ old('exam_name', $feeStructure->exam_name) }}" 
                                   class="w-full border-gray-300 rounded text-sm focus:ring-2 focus:ring-green-300 focus:outline-none" 
                                   placeholder="Enter exam name (if applicable)">
                        </div>

                        <!-- Description -->
                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                            <input type="text" name="description" value="{{ old('description', $feeStructure->description) }}" 
                                   class="w-full border-gray-300 rounded text-sm focus:ring-2 focus:ring-green-300 focus:outline-none" 
